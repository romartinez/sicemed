    ...
    public static class SessionExtensions
    {
        public static void Delete<TEntity>(this ISession session, object id)
        {
            ...
            catch(GenericADOException ex)
            {
                ...
                {
                    throw new ValidationErrorException("No se puede eliminar la entidad ya que hay otras entidades asociadas a esta. Elimine las demás entidades y luego proceda a eliminarla.");
                }
                throw;
            }
        }
