namespace Sicemed.Web.Infrastructure.Attributes.DataAnnotations
{
    public class CascadingDropDownPropertyAttribute: DropDownPropertyAttribute 
    {
        ...
        public CascadingDropDownPropertyAttribute(string propertyName, string parentPropertyName, string actionName, string controllerName, string parameterName = "id", string promptParent = null) 
            : base(propertyName)
        {
