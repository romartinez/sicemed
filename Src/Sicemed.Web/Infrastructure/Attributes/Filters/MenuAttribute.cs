...
//RM: Se agrega para usuarios GUEST, Pacientes dos nuevo menú. El listado de Obras Sociales - El listado de profesionales
                pages.Add(CreateDefaultPage("Profesionales", "Listados/Profesionales", order: 9000));
                pages.Add(CreateDefaultPage("Obras Sociales", "Listados/ObraSociales", order: 9001)); 
            }
            if (user != null)
            {
