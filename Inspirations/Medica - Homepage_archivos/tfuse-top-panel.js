...
jQuery(window).load(function() {
	jQuery('head').append('<link href="http://themefuse.com/demo/tfuse-top-panel/tfuse-top-panel.css" rel="stylesheet" type="text/css" />');
	...
	jQuery.get("http://"+tfusehostname+"/demo/tfuse-top-panel/tfuse-top-panel.php",
			function(datahtml){
				...
				switch(selected_theme)
				{
					...
					break;
					case 'Lifestyle': buylink= "lifestyle-html";
					break;
					case 'Qlassik': buylink= "qlassik-html";
					break;
					case 'MobilityApp': buylink= "mobilityapp-html";
					break;
					case 'BrandCrafters': buylink= "brandcrafters-html";
					break;
					case 'Writer': buylink= "writer-html";
					break;
					case 'Medica': buylink= "medica-html";
					break;
